...
<div class="untree_co-section product-section before-footer-section">
    <form action="/products" method="get" class="text-center">
        <div class="container">
            <div class="row">
                <!-- Start Column 1 -->
                <c:forEach items="${danhsach}" var="shop" varStatus="loop">
                    <div class="col-12 col-md-4 col-lg-3 mb-5">
                        <div class="product-item">
                            <img src="${shop.imageurl}" class="img-fluid product-thumbnail">
                            ...
                            <input type="hidden" name="idAccount${loop.index + 1}" value="${shop.idAcc.getId}">
                        </div>
                    </div>
                </c:forEach>
                <!-- End Column 1 -->
